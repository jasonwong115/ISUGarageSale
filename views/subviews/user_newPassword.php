...
<IMG src="<?php echo $app->inner_path('images/newPass.png'); ?>"> 
<br><br>

<form id="form1" id="form1" action="changePasswordAction" method="POST">
    ...
    <span class="small">Forgot your 
            <a href="<?php echo $app->form_path('user/forgottenUsername'); ?>" target="_blank" class = "orange-links">Password</a>?
    </label>
	 <input type="password" name = "oldValue">


    <label>New Password
    </label>
	 <input type="password" name = "newValue">



    <label>Retype Password
    </label>
	 <input type="password" name = "newValueR">
