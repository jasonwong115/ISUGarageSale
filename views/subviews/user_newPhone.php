...
<IMG src="<?php echo $app->inner_path('images/newPhone.png'); ?>"> 
<br><br>

<form id="form1" id="form1" action="changePhoneAction" method="POST">
	 <label>Enter your netID
    </label>
    <input type="text" name="netID">
    
    <label>Old Phone 
    <span class="small">Please enter your current phone number</a>
    </label>
