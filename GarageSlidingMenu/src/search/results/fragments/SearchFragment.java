...
public class SearchFragment extends ListFragment{
	...
	//Useful variables
	private static String url_create_product = "webservice/retrieve_searched_listings.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (getActivity().getIntent().getExtras()!=null 
        		&& getActivity().getIntent().getExtras().containsKey("search")) {
            searchTerm = extras.getString("search");
        }
        
        //Remove any previous category searches
        if(getActivity().getIntent().getExtras().containsKey("searchCategory")){
        	getActivity().getIntent().removeExtra("searchCategory");
        }
	...
	/*
	 * Dialog to show if listings failed to load
	 */
	...
	/**
	 * Background Async Task to retrieve listings searched for
	 * */
	class RetrieveListings extends AsyncTask<Void, Integer, ArrayList<Listing>> {
		...
		protected ArrayList<Listing> doInBackground(Void... args) {
	        ...
	        String inputSearchTerm = searchTerm;
			
			// Building Parameters
			List<NameValuePair> params = new ArrayList<NameValuePair>();
			params.add(new BasicNameValuePair("inputSearchTerm", inputSearchTerm));
