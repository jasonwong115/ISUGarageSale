...
/**
 * Fragment displays all offers the user has submitted
 * @author jasonwong
 * 
 */
public class MyOffersFragment extends ListFragment{
	
	/*
	 * Interface used so main activity can listen for any clicking on an offer
	 */
	public interface OnOfferSelectedListener {
	      public void onOfferSelected(Offer offer);
	} // End of OnOfferSelectedListener
	
	OnOfferSelectedListener listener;
	
	//Useful variables
	private static String url_create_product = "webservice/retrieve_offers_submitted.php";
	...
	/**
	 * Background Async Task to retrieve offers the user has submitted
	 * */
			...
			try {
				...
				if (success==1) {
                    ...
                    for (int i = 0; i < offers.length(); i++) {
            			...
            			Offer o = new Offer(1,sellerID, buyerID, listingID, productName,
